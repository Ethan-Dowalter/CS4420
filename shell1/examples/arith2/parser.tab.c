...
{
       0,    45,    45,    46,    49,    50,    53,    55,    59,    61,
      69,    88,    93,   104,   105,   106,   107
};
#endif
...
{
  "$end", "error", "$undefined", "EOLN", "SEMI", "PLUS", "MINUS", "TIMES",
  "DIVIDE", "ASSIGN", "VARIABLE", "NUMBER", "$accept", "input", "lines",
  "oneline", "line", "expr", "rhs", "oper", YY_NULLPTR
};
#endif
...
{
      -3,     1,    -4,     1,    16,    17,    18,    19,     9,    10,
       2,    11,     2,     8,    12,     2,    21,     0,     0,    14,
       0,    15
};
...
{
       0,     1,    10,    13,    14,    15,    16,    17,     9,     0,
       3,     4,    11,    18,    14,    16,     5,     6,     7,     8,
      19,    18
};
...
#line 62 "parser.y" /* yacc.c:1646  */
    {
		    (yyvsp[-2].pass)->next = (yyvsp[0].pass);
		    (yyval.pass) = (yyvsp[-2].pass);
		}
...
#line 70 "parser.y" /* yacc.c:1646  */
    {
	      ...
	      pass->variable = (yyvsp[-2].string);
	      /* un-build the operator chain */
	      for (pop = (yyvsp[0].pop); pop; pop = pop->next) {
...
#line 89 "parser.y" /* yacc.c:1646  */
    {
	      (yyval.pop) = (struct opchain *) malloc(sizeof(struct opchain));
	      (yyval.pop)->number = (yyvsp[0].number);
	  }
...
#line 94 "parser.y" /* yacc.c:1646  */
    {
	      (yyval.pop) = (struct opchain *) malloc(sizeof(struct opchain));
	      (yyval.pop)->operator = (yyvsp[-1].operator);
	      (yyval.pop)->number = (yyvsp[-2].number);
	      (yyval.pop)->next = (yyvsp[0].pop);
	  }
